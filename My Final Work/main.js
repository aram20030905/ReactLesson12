document.addEventListener('DOMContentLoaded', () => {
    ...
    function getItemDetails(button) {
        ...
        const backgroundImage = isAudio ? encodeURIComponent(itemElement.querySelector('.myus3 img').getAttribute('src')) : '';
    ...
    function appendAudioItem(container, item) {
        ...
        audioItem.innerHTML = `
            ...
            <img src = "${decodeURIComponent(item.backgroundImage)}">
            <audio controls>
